...
.td, .th   { display: table-cell; width: 100%; }
...
.aa_ahmadawais{
  ...
  margin: 5rem auto;
     ...
     <title>Welcome to Personal Loan App</title>
</head>
<body>
<h1>Welcome to Personal Loan App</h1><br>
<form>
<div class="container" style="float: center;width: 50%;">
				...
				<table border = "1">
					...
					<tr><td><a href="getAllUser.jsp">Get All User</a></td></tr>
